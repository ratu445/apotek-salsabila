            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('level_user') is-invalid @enderror" 
                        ...
                        <option value="1" {{ old('level_user') == 1 ? 'selected' : '' }}>Apoteker</option>
                        <option value="2" {{ old('level_user') == 2 ? 'selected' : '' }}>Asisten Apoteker</option>
                        <option value="3" {{ old('level_user') == 3 ? 'selected' : '' }}>Kasir</option>
                        <option value="4" {{ old('level_user') == 4 ? 'selected' : '' }}>Admin Gudang</option>
                    </select>
                    @error('level_user')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
